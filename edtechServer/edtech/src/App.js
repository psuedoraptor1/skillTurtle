...
import CreateCourse from './components/Home/Admin/CreateCourse/CreateCourse.jsx'
import AdminCourses from './components/Home/Admin/AdminCourses/AdminCourses.jsx'
import Users from './components/Home/Admin/Users/Users.jsx'
        ...
        loading ? (
          ...
          <>
            ...
            <Routes>
              ...
              <Route path="/courses" element={<ProtectedRoute isAuthenticated={isAuthenticated}><Courses user={user} /></ProtectedRoute>} />
